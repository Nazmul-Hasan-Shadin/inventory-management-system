...
const MainTheme = () => {
   return (
      <div className='bg-[#F3F4F6] p-14 pb-48' data-aos="fade-up" data-aos-anchor-placement="top-bottom " data-aos-duration="1000">
...
<div className='space-y-16' >
   ...
   {/* ================1st row================== */}
   <div data-aos="fade-up" data-aos-duration="2000" className='grid grid-cols-2 md:grid-cols-5 gap-5'>
   ...
   <div data-aos="fade-up" data-aos-duration="3000" className='grid grid-cols-2  md:grid-cols-4 gap-5 lg:px-28'>
      <div className='h-40 text-center'>
         <div className='bg-[#f8f8fa] text-5xl p-12 '>
   ...
   <div data-aos="fade-up" data-aos-duration="3000" className='grid grid-cols-2 md:grid-cols-5 gap-5'>
      <div className='h-40 text-center'>
         <div className='bg-[#f8f8fa] text-5xl p-12 '>
